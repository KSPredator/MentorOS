...
class Orchestrator:
    ...
    def _handle_podcast(self, message: str, emit: Emit) -> dict:
        ...
        _emit("stage", {"stage": "generating"})
        script, audio_url, audio_filename = podcast_service.generate_with_audio(message, context_text, sources=sources)
        ...
        content = podcast_service.script_to_markdown(script, audio_url=audio_url)
        retrieved = [
            {
                "chunk_id": c.chunk_id,
                "source_file": c.source_file,
        ...
        return {
            ...
            "podcast_audio_filename": audio_filename,
            "memory_updates": [],
        }
