"""
Podcast Router — Phase 12 Two-Voice Audio Explainer
===================================================
Endpoints:
  POST /api/podcast/generate  — Generate 2-person dialogue script & synthesized MP3
  GET  /api/podcast/audio/{filename} — Stream/download podcast MP3
  GET  /api/podcast/list      — List all saved podcast episodes
  GET  /api/podcast/{id}      — Retrieve podcast episode metadata
"""
...
from api.models import PodcastEpisodeResponse, PodcastGenerateRequest
    ...
    for ep in episodes:
        ...
        result.append(
            PodcastEpisodeResponse(
                ...
                audio_url=f"/api/podcast/audio/{audio_name}",
